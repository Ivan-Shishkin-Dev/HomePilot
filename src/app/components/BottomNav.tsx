...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile top bar */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-[#0A0F1E]/95 backdrop-blur-xl border-b border-white/[0.06]">
      ...
      {mobileOpen && (
        ...
        >
          <div
            className="absolute top-[57px] left-0 right-0 bg-[#0A0F1E] border-b border-white/[0.06] py-2"
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-5 py-3 transition-all ${
                    active
                      ...
                      : "text-[#8B95A5] hover:text-white hover:bg-white/[0.03]"
                  }`}
                >
      ...
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex fixed top-0 left-0 bottom-0 w-[240px] bg-[#080C19] border-r border-white/[0.06] flex-col z-40">
        {/* Logo */}
        ...
        <nav className="flex-1 py-4 px-3">
          <p className="text-[#4B5563] text-[11px] tracking-wider px-3 mb-2" style={{ fontWeight: 600 }}>
            NAVIGATION
          </p>
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all text-left ${
                    active
                      ? "text-white bg-[#3B82F6]/15 border border-[#3B82F6]/20"
                      : "text-[#8B95A5] hover:text-white hover:bg-white/[0.04] border border-transparent"
                  }`}
                >
